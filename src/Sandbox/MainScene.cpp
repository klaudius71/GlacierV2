...
void MainScene::InitializeScene()
{
	...
	dir_light = CreateGameObject("Directional Light");
	...
	GameObject*& cube = cubes.emplace_back(CreateGameObject("Cube1"));
	...
	auto& cube2 = cubes.emplace_back(CreateGameObject("Cube2", cube));
