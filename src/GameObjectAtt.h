...
class GameObjectAtt
{
	...
	static std::vector<GameObject*>& GetChildren(GameObject& obj) { return obj.GetChildren(); }
	static SceneGraph::SceneGraphRef& GetSceneGraphRef(GameObject& obj) { return obj.GetSceneGraphRef(); }
	static void SetSceneGraphRef(GameObject& obj, SceneGraph::SceneGraphRef ref) { obj.SetSceneGraphRef(ref); }
};
