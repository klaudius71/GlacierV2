...
struct PlayerTankPrefab : public Prefab
{
	virtual GameObject ApplyPrefab(Scene& scn) override
	{
		...
		base->EmplaceComponent<MeshComponent>((const ModelOpenGL*)ModelLoader::Get("TankBase"));
		...
		wheels->EmplaceComponent<MeshComponent>((const ModelOpenGL*)ModelLoader::Get("TankWheels"));
		...
		turret->EmplaceComponent<MeshComponent>((const ModelOpenGL*)ModelLoader::Get("TankTurret"));
		...
		turret_barrel->EmplaceComponent<MeshComponent>((const ModelOpenGL*)ModelLoader::Get("TankTurretBarrel"));
